...
# Onboard Reference Clock (Differential)
set_property PACKAGE_PIN T3 [get_ports clk_p] 
set_property PACKAGE_PIN T2 [get_ports clk_n] 
...
set_property PACKAGE_PIN G5 [get_ports rst_n] 
set_property IOSTANDARD LVCMOS12 [get_ports rst_n]

# Ethernet Data Input
set_property PACKAGE_PIN J20 [get_ports eth_data_in] 
set_property IOSTANDARD LVCMOS18 [get_ports eth_data_in]

# HDMI TMDS Outputs
set_property PACKAGE_PIN R12 [get_ports tmds_clk_p] 
set_property PACKAGE_PIN R11 [get_ports tmds_clk_n] 
set_property PACKAGE_PIN T12 [get_ports {tmds_data_p[0]}] 
set_property PACKAGE_PIN T11 [get_ports {tmds_data_n[0]}] 
set_property PACKAGE_PIN U12 [get_ports {tmds_data_p[1]}] 
set_property PACKAGE_PIN U11 [get_ports {tmds_data_n[1]}] 
set_property PACKAGE_PIN V12 [get_ports {tmds_data_p[2]}] 
set_property PACKAGE_PIN V11 [get_ports {tmds_data_n[2]}] 
...
# et_property PACKAGE_PIN F25        [get_ports "DDR4_A15_CAS_B"] ;# Bank  66 VCCO - VCC1V2   - IO_L16N_T2U_N7_QBC_AD3N_66
#set_property IOSTANDARD  SSTL12     [get_ports "DDR4_A15_CAS_B"] ;# Bank  66 VCCO - VCC1V2   - IO_L16N_T2U_N7_QBC_AD3N_66
# et_property PACKAGE_PIN F24        [get_ports "DDR4_A16_RAS_B"] ;# Bank  66 VCCO - VCC1V2   - IO_L16P_T2U_N6_QBC_AD3P_66
#set_property IOSTANDARD  SSTL12     [get_ports "DDR4_A16_RAS_B"] ;# Bank  66 VCCO - VCC1V2   - IO_L16P_T2U_N6_QBC_AD3P_66
# et_property PACKAGE_PIN J26        [get_ports "DDR4_ACT_B"] ;# Bank  66 VCCO - VCC1V2   - IO_L15N_T2L_N5_AD11N_66
#set_property IOSTANDARD  SSTL12     [get_ports "DDR4_ACT_B"] ;# Bank  66 VCCO - VCC1V2   - IO_L15N_T2L_N5_AD11N_66
# et_property PACKAGE_PIN J25        [get_ports "DDR4_PAR"] ;# Bank  66 VCCO - VCC1V2   - IO_L15P_T2L_N4_AD11P_66
...
#set_property PACKAGE_PIN AC17      [get_ports "FMC_HPC0_LA03_N"] ;# Bank  64 VCCO - VADJ_FMC - IO_L22N_T3U_N7_DBC_AD0N_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA03_N"] ;# Bank  64 VCCO - VADJ_FMC - IO_L22N_T3U_N7_DBC_AD0N_64
#set_property PACKAGE_PIN AB17      [get_ports "FMC_HPC0_LA03_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L22P_T3U_N6_DBC_AD0P_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA03_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L22P_T3U_N6_DBC_AD0P_64
#set_property PACKAGE_PIN AB20      [get_ports "FMC_HPC0_LA04_N"] ;# Bank  64 VCCO - VADJ_FMC - IO_L21N_T3L_N5_AD8N_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA04_N"] ;# Bank  64 VCCO - VADJ_FMC - IO_L21N_T3L_N5_AD8N_64
#set_property PACKAGE_PIN AA20      [get_ports "FMC_HPC0_LA04_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L21P_T3L_N4_AD8P_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA04_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L21P_T3L_N4_AD8P_64
#set_property PACKAGE_PIN AB19      [get_ports "FMC_HPC0_LA05_N"] ;# Bank  64 VCCO - VADJ_FMC - IO_L20N_T3L_N3_AD1N_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA05_N"] ;# Bank  64 VCCO - VADJ_FMC - IO_L20N_T3L_N3_AD1N_64
#set_property PACKAGE_PIN AA19      [get_ports "FMC_HPC0_LA05_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L20P_T3L_N2_AD1P_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA05_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L20P_T3L_N2_AD1P_64
...
#set_property PACKAGE_PIN AD16      [get_ports "FMC_HPC0_LA07_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L18P_T2U_N10_AD2P_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA07_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L18P_T2U_N10_AD2P_64
...
#set_property PACKAGE_PIN AD18      [get_ports "FMC_HPC0_LA09_N"] ;# Bank  64 VCCO - VADJ_FMC - IO_L16N_T2U_N7_QBC_AD3N_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA09_N"] ;# Bank  64 VCCO - VADJ_FMC - IO_L16N_T2U_N7_QBC_AD3N_64
#set_property PACKAGE_PIN AC18      [get_ports "FMC_HPC0_LA09_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L16P_T2U_N6_QBC_AD3P_64
#set_property IOSTANDARD  LVDS      [get_ports "FMC_HPC0_LA09_P"] ;# Bank  64 VCCO - VADJ_FMC - IO_L16P_T2U_N6_QBC_AD3P_64
...
#set_property PACKAGE_PIN H13       [get_ports "FMC_HPC0_PG_M2C"] ;# Bank  87 VCCO - VCC3V3   - IO_L2N_AD14N_87
#set_property IOSTANDARD  LVCMOS33  [get_ports "FMC_HPC0_PG_M2C"] ;# Bank  87 VCCO - VCC3V3   - IO_L2N_AD14N_87
...
#set_property PACKAGE_PIN AD15      [get_ports "IIC_SCL_HDMI"] ;# Bank  84 VCCO - VCC3V3   - IO_L3P_AD9P_84
#set_property IOSTANDARD  LVCMOS33  [get_ports "IIC_SCL_HDMI"] ;# Bank  84 VCCO - VCC3V3   - IO_L3P_AD9P_84
...
#set_property PACKAGE_PIN AE13      [get_ports "IIC_MAIN_SCL_LS"] ;# Bank  84 VCCO - VCC3V3   - IO_L2P_AD10P_84
#set_property IOSTANDARD  LVCMOS33  [get_ports "IIC_MAIN_SCL_LS"] ;# Bank  84 VCCO - VCC3V3   - IO_L2P_AD10P_84
...
#set_property PACKAGE_PIN E4        [get_ports "FMC_HPC0_DP1_C2M_N"] ;# Bank 227 - MGTYTXN1_227
#set_property PACKAGE_PIN D6        [get_ports "FMC_HPC0_DP2_C2M_N"] ;# Bank 227 - MGTYTXN2_227
#set_property PACKAGE_PIN B6        [get_ports "FMC_HPC0_DP3_C2M_N"] ;# Bank 227 - MGTYTXN3_227
#set_property PACKAGE_PIN F7        [get_ports "FMC_HPC0_DP0_C2M_P"] ;# Bank 227 - MGTYTXP0_227
#set_property PACKAGE_PIN E5        [get_ports "FMC_HPC0_DP1_C2M_P"] ;# Bank 227 - MGTYTXP1_227
#set_property PACKAGE_PIN D7        [get_ports "FMC_HPC0_DP2_C2M_P"] ;# Bank 227 - MGTYTXP2_227
#set_property PACKAGE_PIN B7        [get_ports "FMC_HPC0_DP3_C2M_P"] ;# Bank 227 - MGTYTXP3_227
